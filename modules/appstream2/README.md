...
| <a name="input_enable_homefolder"></a> [enable\_homefolder](#input\_enable\_homefolder) | Enable or disable the HOMEFOLDER storage connector on the Stack. | `bool` | n/a | yes |
